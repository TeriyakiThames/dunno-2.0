...
CREATE TABLE "diet_profile" (
	...
	"carbs_intake" real NOT NULL,
	"protein_intake" real NOT NULL,
	"fat_intake" real NOT NULL,
...
CREATE TABLE "meal_history" (
	...
	"edited_carbs" real NOT NULL,
	"edited_protein" real NOT NULL,
	"edited_fat" real NOT NULL,
	"edited_alcohol" real NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "user" (
	...
	"goal" "goal" DEFAULT 'balanced' NOT NULL,
	"target_calorie" real NOT NULL,
	"target_fat" real NOT NULL,
	"target_protein" real NOT NULL,
	"target_carbs" real NOT NULL,
	CONSTRAINT "user_email_unique" UNIQUE("email"),
	CONSTRAINT "activity_level check" CHECK ("user"."activity_level" IN (1.2, 1.375, 1.55, 1.725, 1.9))
);
--> statement-breakpoint
ALTER TABLE "user" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
ALTER TABLE "diet_profile" ADD CONSTRAINT "diet_profile_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "dish_component_map" ADD CONSTRAINT "dish_component_map_dish_id_dish_id_fk" FOREIGN KEY ("dish_id") REFERENCES "public"."dish"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "dish_component_map" ADD CONSTRAINT "dish_component_map_component_id_component_id_fk" FOREIGN KEY ("component_id") REFERENCES "public"."component"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "meal_history" ADD CONSTRAINT "meal_history_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "meal_history" ADD CONSTRAINT "meal_history_dish_id_dish_id_fk" FOREIGN KEY ("dish_id") REFERENCES "public"."dish"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "restaurant_type_map" ADD CONSTRAINT "restaurant_type_map_res_id_restaurant_id_fk" FOREIGN KEY ("res_id") REFERENCES "public"."restaurant"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "restaurant_type_map" ADD CONSTRAINT "restaurant_type_map_type_id_restaurant_type_id_fk" FOREIGN KEY ("type_id") REFERENCES "public"."restaurant_type"("id") ON DELETE cascade ON UPDATE no action;